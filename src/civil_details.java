 ...
 * @author hp
 */
public class civil_details extends javax.swing.JFrame {

    /**
     * Creates new form civil_details
     */
    public civil_details() {
        initComponents();
    ...
    private void initComponents() {
        ...
        ta1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Project ID", "Project name", "Contractor name", "Area name", "Work Start Date", "Supervisor ID", "Budget Fixed", "Laborers Required"
            }
        ));
...
while(rs.next()){
    ...
    String work_start_date=rs.getString("work_start_date");
    String supervisor_ID=rs.getString("supervisor_ID");
    String budget_fixed=rs.getString("budget_fixed");
    String laborers_req=rs.getString("laborers_req");
    model.addRow(new Object[]{project_ID,proj_name,contractor_name,area_name,work_start_date,supervisor_ID,budget_fixed,laborers_req});
}
conn.close();
rs.close();
st.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(civil_details.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new civil_details().setVisible(true);
            }
        });
    }
